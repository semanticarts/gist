...
The new model provides flexibility to express more nuanced types of address usage and communication preferences than has previously been available. Consult [xxxx] for full documentation of the model to learn how to take advantage of these options.
